...
class ViewControllerCatAprendeTrigo: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sen" {
            ...
            let listaDesc2 : [String] = ["Tenemos nuestra función original, y lo único que nos importa realmente es lo que esta dentro de los paréntesis.", "Se deriva el ángulo, que es lo que esta dentro del paréntesis.", "Tenemos este termino y se tiene que derivar para poder seguir", "Este es el resultado de la derivacion del termino anterior","Finalmente por regla Seno se cambia por Coseno."]
            ...
            let listaDesc2 : [String] = ["Tenemos nuestra función original, y lo único que nos importa realmente es lo que esta dentro de los paréntesis.", "Se deriva el ángulo, que es lo que esta dentro del paréntesis.", "Tenemos este termino y se tiene que derivar para poder seguir", "Este es el resultado de la derivacion del termino anterior","Por regla se cambia Coseno por Seno y se hace negativo."]
            ...
            let listaDesc2 : [String] = ["Tenemos nuestra función original, y lo único que nos importa realmente es lo que esta dentro de los paréntesis.", "Se deriva el ángulo, que es lo que esta dentro del paréntesis.", "Tenemos Seno como termino y se tiene que derivar para poder seguir", "Coseno es el resultado de la derivacion del termino anterior","Por regla se cambia Tangente por Cos(u)Sec^2(u)."]
