...
class ViewControllerCatAprende: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "poli" {
            ...
            let listaDesc2 : [String] = ["Tenemos nuestra función original.","Para manejar fácilmente la derivación, nos enfocaremos en cada término individualmente. Para derivar este primer termino, agarramos el exponente de la variable X que es 4 y lo multiplicamos por su coeficiente que también es 4. Después le restamos 1 al exponente.","Ahora nos enfocamos en el segundo término, y hacemos lo mismo que en el caso pasado. Bajamos el exponente de X y se lo multiplicamos por el coeficiente de la variable X. Después, restamos 1 al exponente de X.","Avanzamos al siguiente término. Cuando vemos que falta el exponente de una variable es por que es igual a 1. Ahora volvemos a hacer los pasos anteriores y veremos que el exponente se reduce a 0, cuando ocurre esto podemos eliminar X.","Terminamos nuestra derivación polinomio."]
